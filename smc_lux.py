"""LuxAlgo SMC port — bar-by-bar detector for swings, BOS/CHoCH, OB, FVG.

Originally authored as a 1:1 port of the LuxAlgo SMC Pine Script. See
`pkg/mgold/structure.py` for the Polars-friendly wrapper used by scenarios.
"""
